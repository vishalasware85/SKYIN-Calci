...
import com.skyncalci.calculator.evaluator.base.Evaluator;
import com.skyncalci.calculator.evaluator.base.LogicEvaluator;
import com.skyncalci.calculator.evaluator.thread.ResultCallback;
import com.skyncalci.calculator.history.HistoryActivity;
import com.skyncalci.calculator.history.ResultEntry;
import com.skyncalci.calculator.symja.models.DerivativeItem;
import com.skyncalci.calculator.symja.models.ExprInput;
import com.skyncalci.calculator.symja.models.PrimeFactorItem;
import com.skyncalci.calculator.symja.models.SolveItem;
import com.skyncalci.ncalc.settings.CalculatorSetting;
import com.skyncalci.ncalc.userinterface.ThemeManager;
import com.skyncalci.ncalc.utils.ClipboardManager;
...
public class BasicCalculatorActivity extends AbstractCalculatorActivity
        implements LogicEvaluator.EvaluateCallback, KeyboardListener, View.OnClickListener, PaymentResultWithDataListener {
    ...
    public static Activity basicCalcActivity;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        basicCalcActivity=this;
        updateCheck();

//        if (!mPermissionsRequested && !OverlayPermission.hasRuntimePermissionToDrawOverlay(BasicCalculatorActivity.this)) {
//            @SuppressWarnings("NewApi")
//            Intent myIntent = OverlayPermission.createIntentToRequestOverlayPermission(BasicCalculatorActivity.this);
//            startActivityForResult(myIntent, REQUEST_CODE_HOVER_PERMISSION);
//        }else {
//            Intent startHoverIntent = new Intent(BasicCalculatorActivity.this, SimpleHoverMenu.class);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<Boolean>() {
                    ...
                    public void onComplete(@NonNull Task<Boolean> task) {
                        if (task.isSuccessful()) {
                            ...
                            boolean isIssue=firebaseRemoteConfig.getBoolean("isIssue");
                            double isUpdate = firebaseRemoteConfig.getDouble("updateAvailable");
                            double currVer = Double.parseDouble(BuildConfig.VERSION_NAME);
                            if (isUpdate > currVer){
                                Intent intent=new Intent(BasicCalculatorActivity.this, AppUpdate.class);
                                startActivity(intent);
                            }
                            if (isIssue){
                                startActivity(new Intent(BasicCalculatorActivity.this, AppIssue.class));
                            }
                        } else {
                            Toast.makeText(BasicCalculatorActivity.this, "Fetch failed",
...
//        mGraphView.setPanelState(SlidingUpPanelLayout.PanelState.EXPANDED);
    ...
    public void onPaymentError(int i, String s, PaymentData paymentData) {
        ...
        Log.e("Payment Fail","Payment Fail"+paymentData.getData());
    }
