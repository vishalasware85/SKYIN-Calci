...
import com.skyncalci.calculator.activities.base.AbstractCalculatorActivity;
import com.skyncalci.ncalc.settings.CalculatorSetting;
import com.skyncalci.calculator.evaluator.base.LogicEvaluator;
import com.skyncalci.calculator.evaluator.MathEvaluator;
import com.skyncalci.calculator.evaluator.base.Base;
import com.skyncalci.calculator.evaluator.base.NumberBaseManager;
import com.skyncalci.ncalc.view.AnimationFinishedListener;
import com.skyncalci.ncalc.view.ButtonID;
import com.skyncalci.ncalc.view.CalculatorEditText;
import com.skyncalci.ncalc.view.RevealView;
...
public class LogicCalculatorActivity extends AbstractCalculatorActivity
    ...
    private Button dec,hex,bin,oct,and,or,neg,equal,clear,geq,leq,bracOen,bracClose,lt,gt,neq,truee,falsee,a,b,c,d,e,f,one,two,three,four,five,six,seven,eight,nine,zero,
    mul,plus,minus,equalpad;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        and=findViewById(R.id.op_and);
        or=findViewById(R.id.op_or);
        neg=findViewById(R.id.op_neg);
        equal=findViewById(R.id.op_equal);
        clear=findViewById(R.id.btn_clear);
        geq=findViewById(R.id.btn_geq);
        leq=findViewById(R.id.btn_leq);
        bracOen=findViewById(R.id.btn_left_paratheses);
        bracClose=findViewById(R.id.btn_right_parathese);
        backBtn=findViewById(R.id.btn_delete);
        lt=findViewById(R.id.btn_lt);
        gt=findViewById(R.id.btn_gt);
        neq=findViewById(R.id.btn_neq);
        truee=findViewById(R.id.btn_true);
        falsee=findViewById(R.id.btn_false);
        ...
        one=findViewById(R.id.digit1);
        two=findViewById(R.id.digit2);
        three=findViewById(R.id.digit3);
        four=findViewById(R.id.digit4);
        five=findViewById(R.id.digit5);
        six=findViewById(R.id.digit6);
        seven=findViewById(R.id.digit7);
        eight=findViewById(R.id.digit8);
        nine=findViewById(R.id.digit9);
        zero=findViewById(R.id.digit0);
        mul=findViewById(R.id.btn_mul);
        plus=findViewById(R.id.btn_plus);
        minus=findViewById(R.id.btn_minus);
        equalpad=findViewById(R.id.btn_equal);

        BounceView.addAnimTo(dec);
        BounceView.addAnimTo(hex);
        BounceView.addAnimTo(bin);
        BounceView.addAnimTo(oct);
        BounceView.addAnimTo(and);
        BounceView.addAnimTo(or);
        BounceView.addAnimTo(neg);
        BounceView.addAnimTo(equal);
        BounceView.addAnimTo(clear);
        BounceView.addAnimTo(geq);
        BounceView.addAnimTo(leq);
        BounceView.addAnimTo(bracOen);
        BounceView.addAnimTo(bracClose);
        BounceView.addAnimTo(backBtn);
        BounceView.addAnimTo(lt);
        BounceView.addAnimTo(gt);
        BounceView.addAnimTo(neq);
        BounceView.addAnimTo(truee);
        BounceView.addAnimTo(falsee);
        BounceView.addAnimTo(a);
        BounceView.addAnimTo(b);
        BounceView.addAnimTo(c);
        BounceView.addAnimTo(d);
        BounceView.addAnimTo(e);
        BounceView.addAnimTo(f);
        ...
        BounceView.addAnimTo(mul);
        BounceView.addAnimTo(plus);
        BounceView.addAnimTo(minus);
        BounceView.addAnimTo(equalpad);
    ...
    public void clickClear() {
        ...
        int color = getResources().getColor(R.color.blueReveal);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            animateRipple(mCurrentButton, color, new AnimationFinishedListener() {
                @Override
                public void onAnimationFinished() {
