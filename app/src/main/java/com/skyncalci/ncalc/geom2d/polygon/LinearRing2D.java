...
public class LinearRing2D extends LinearCurve2D {
    ...
    public LinearRing2D simplify(double distMax) {
        return new LinearRing2D(com.skyncalci.ncalc.geom2d.polygon.Polylines2D.simplifyClosedPolyline(this.vertices, distMax));
    }
    ...
    public double windingAngle(Point2D point) {
        int wn = com.skyncalci.ncalc.geom2d.polygon.Polygons2D.windingNumber(this.vertices, point);
        return wn * 2 * Math.PI;
    }
