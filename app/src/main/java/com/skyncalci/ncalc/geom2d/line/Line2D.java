...
package com.skyncalci.ncalc.geom2d.line;

import android.graphics.Path;

import com.skyncalci.ncalc.geom2d.GeometricObject2D;
import com.skyncalci.ncalc.geom2d.Point2D;
import com.skyncalci.ncalc.geom2d.Vector2D;
import com.skyncalci.ncalc.geom2d.curve.AbstractSmoothCurve2D;
import com.skyncalci.ncalc.geom2d.util.Shape2D;

import java.util.Collection;

public class Line2D extends AbstractSmoothCurve2D
        implements com.skyncalci.ncalc.geom2d.line.LinearShape2D, Cloneable {
    ...
    public Line2D(com.skyncalci.ncalc.geom2d.line.StraightLine2D mLine) {
    ...
    public boolean isColinear(com.skyncalci.ncalc.geom2d.line.LinearShape2D line) {
        return new com.skyncalci.ncalc.geom2d.line.LineSegment2D(p1, p2).isColinear(line);
    }
     ...
     */
    public boolean isParallel(com.skyncalci.ncalc.geom2d.line.LinearShape2D line) {
        return new com.skyncalci.ncalc.geom2d.line.LineSegment2D(p1, p2).isParallel(line);
    }

    @Override
    public boolean containsProjection(Point2D point) {
        double pos = new com.skyncalci.ncalc.geom2d.line.LineSegment2D(p1, p2).project(point);
    ...
    public double[][] parametric() {
        return new com.skyncalci.ncalc.geom2d.line.LineSegment2D(p1, p2).parametric();
    }
    ...
    public double[] cartesianEquation() {
        return new com.skyncalci.ncalc.geom2d.line.LineSegment2D(p1, p2).cartesianEquation();
    }

    public double[] polarCoefficients() {
        return new com.skyncalci.ncalc.geom2d.line.LineSegment2D(p1, p2).polarCoefficients();
    }

    public double[] polarCoefficientsSigned() {
        return new com.skyncalci.ncalc.geom2d.line.LineSegment2D(p1, p2).polarCoefficientsSigned();
    }

    public double horizontalAngle() {
        return new com.skyncalci.ncalc.geom2d.line.LineSegment2D(p1, p2).horizontalAngle();
    }

    /* (non-Javadoc)
     * @see LinearShape2D#intersection(LinearShape2D)
     */
    public Point2D intersection(com.skyncalci.ncalc.geom2d.line.LinearShape2D line) {
        return new com.skyncalci.ncalc.geom2d.line.LineSegment2D(p1, p2).intersection(line);
    }
     ...
     */
    public com.skyncalci.ncalc.geom2d.line.StraightLine2D supportingLine() {
        return new com.skyncalci.ncalc.geom2d.line.StraightLine2D(p1, p2);
    }
    ...
    public double signedDistance(double x, double y) {
        return new com.skyncalci.ncalc.geom2d.line.LineSegment2D(p1, p2).signedDistance(x, y);
    }

    /**
     * Returns false.
     *
     * @see com.skyncalci.ncalc.geom2d.curve.ContinuousCurve2D#isClosed()
     */
    ...
    public double distance(double x, double y) {
        ...
        com.skyncalci.ncalc.geom2d.line.StraightLine2D support = new com.skyncalci.ncalc.geom2d.line.StraightLine2D(p1, p2);
     ...
     */
    public com.skyncalci.ncalc.geom2d.line.StraightLine2D parallel(Point2D point) {
        return new com.skyncalci.ncalc.geom2d.line.LineSegment2D(p1, p2).parallel(point);
    }
     ...
     */
    public com.skyncalci.ncalc.geom2d.line.StraightLine2D perpendicular(Point2D point) {
        return new com.skyncalci.ncalc.geom2d.line.LineSegment2D(p1, p2).perpendicular(point);
    }
    ...
    @Override
    public com.skyncalci.ncalc.geom2d.polygon.LinearCurve2D asPolyline(int n) {
        return null;
    }

    public double windingAngle(Point2D point) {
        return new com.skyncalci.ncalc.geom2d.line.LineSegment2D(p1, p2).windingAngle(point);
    }

    public boolean isInside(Point2D point) {
        return new com.skyncalci.ncalc.geom2d.line.LineSegment2D(p1, p2).signedDistance(point) < 0;
    }
    ...
    public double position(Point2D point) {
        return new com.skyncalci.ncalc.geom2d.line.LineSegment2D(p1, p2).position(point);
    }

    public double project(Point2D point) {
        return new com.skyncalci.ncalc.geom2d.line.LineSegment2D(p1, p2).project(point);
    }
     ...
     */
    public Collection<Point2D> intersections(com.skyncalci.ncalc.geom2d.line.LinearShape2D line) {
        return new com.skyncalci.ncalc.geom2d.line.LineSegment2D(p1, p2).intersections(line);
    }
    ...
    public boolean contains(double x, double y) {
        return new com.skyncalci.ncalc.geom2d.line.LineSegment2D(p1, p2).contains(x, y);
    }
