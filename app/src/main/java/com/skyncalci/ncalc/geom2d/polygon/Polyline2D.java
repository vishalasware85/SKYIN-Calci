...
import com.skyncalci.ncalc.geom2d.line.LineSegment2D;
import com.skyncalci.ncalc.geom2d.line.StraightLine2D;
...
public class Polyline2D extends LinearCurve2D
{
    ...
    public Polyline2D simplify(double distMax) {
        return new Polyline2D(com.skyncalci.ncalc.geom2d.polygon.Polylines2D.simplifyPolyline(this.vertices, distMax));
    }
     ...
     * (non-Javadoc)
     * 
     * @see com.example.duy.com.skyncalci.calculator.geom2d.OrientedCurve2D#windingAngle(Point2D)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.example.duy.com.skyncalci.calculator.geom2d.OrientedCurve2D#isInside(Point2D)
     */
    public boolean isInside(Point2D pt) {
        if (new com.skyncalci.ncalc.geom2d.polygon.LinearRing2D(this.vertexArray()).isInside(pt))
            return true;
     ...
     * (non-Javadoc)
     * 
     * @see com.example.duy.com.skyncalci.calculator.geom2d.Curve2D#point(double, Point2D)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.example.duy.com.skyncalci.calculator.geom2d.ContinuousCurve2D#appendPath(Path)
     */
