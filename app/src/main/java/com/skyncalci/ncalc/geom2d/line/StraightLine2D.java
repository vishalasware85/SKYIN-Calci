...
import com.skyncalci.ncalc.geom2d.util.EqualUtils;
...
import com.skyncalci.ncalc.geom2d.util.UnboundedShape2DException;
import com.skyncalci.ncalc.geom2d.Vector2D;
import com.skyncalci.ncalc.geom2d.curve.Curve2D;
...
public class StraightLine2D extends AbstractLine2D implements
     ...
     */
    public StraightLine2D(com.skyncalci.ncalc.geom2d.line.LinearShape2D line) {
     ...
     */
    public StraightLine2D(com.skyncalci.ncalc.geom2d.line.LinearShape2D line, Point2D point) {
    ...
    public static Point2D getMidPoint(com.skyncalci.ncalc.geom2d.line.Line2D line2D) {
     ...
     * @since 0.6.3
     */
    public static StraightLine2D createParallel(com.skyncalci.ncalc.geom2d.line.LinearShape2D line,
                                                Point2D point) {
     ...
     * @since 0.6.3
     */
    public static StraightLine2D createParallel(com.skyncalci.ncalc.geom2d.line.LinearShape2D linear,
                                                double d) {
    ...
    public static StraightLine2D createPerpendicular(
            com.skyncalci.ncalc.geom2d.line.LinearShape2D linear, Point2D point) {
        StraightLine2D line = linear.supportingLine();
