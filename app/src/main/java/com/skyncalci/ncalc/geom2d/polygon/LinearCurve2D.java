 ...
 *
 */
package com.skyncalci.ncalc.geom2d.polygon;
...
import com.skyncalci.ncalc.geom2d.curve.ContinuousCurve2D;
import com.skyncalci.ncalc.geom2d.line.LinearShape2D;
...
public abstract class LinearCurve2D implements ContinuousCurve2D {
     ...
     */
    public abstract com.skyncalci.ncalc.geom2d.line.LineSegment2D edge(int index);
     ...
     */
    public abstract Collection<com.skyncalci.ncalc.geom2d.line.LineSegment2D> edges();

    public com.skyncalci.ncalc.geom2d.line.LineSegment2D firstEdge() {
        if (vertices.size() < 2)
            return null;
        return new com.skyncalci.ncalc.geom2d.line.LineSegment2D(vertices.get(0), vertices.get(1));
    }

    public abstract com.skyncalci.ncalc.geom2d.line.LineSegment2D lastEdge();
    ...
    public double length() {
        double sum = 0;
        for (com.skyncalci.ncalc.geom2d.line.LineSegment2D edge : this.edges())
            sum += edge.length();
        return sum;
    }
    ...
    public double position(double length) {
        ...
        for (com.skyncalci.ncalc.geom2d.line.LineSegment2D edge : edges()) {
     ...
     * (non-Javadoc)
     * 
     * @see com.example.duy.com.skyncalci.calculator.geom2d.OrientedCurve2D#signedDistance(Point2D)
     */
    ...
    public boolean isInside(Point2D point) {
        ...
        int winding = com.skyncalci.ncalc.geom2d.polygon.Polygons2D.windingNumber(this.vertices, point);
        if (area > 0) {
            return winding == 1;
        } else {
            return winding == 0;
     ...
     * (non-Javadoc)
     * 
     * @see com.example.duy.com.skyncalci.calculator.geom2d.OrientedCurve2D#signedDistance(double, double)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.example.duy.com.skyncalci.calculator.geom2d.ContinuousCurve2D#smoothPieces()
     */
    public Collection<? extends com.skyncalci.ncalc.geom2d.line.LineSegment2D> smoothPieces() {
        return edges();
    }
     ...
     * (non-Javadoc)
     * 
     * @see com.example.duy.com.skyncalci.calculator.geom2d.Curve2D#position(Point2D)
     */
    public double position(Point2D point) {
        ...
        int i = 0;
        com.skyncalci.ncalc.geom2d.line.LineSegment2D closest = null;
        for (com.skyncalci.ncalc.geom2d.line.LineSegment2D edge : this.edges()) {
     ...
     * (non-Javadoc)
     * 
     * @see com.example.duy.com.skyncalci.calculator.geom2d.Curve2D#intersections(com.example.duy.com.skyncalci.calculator.geom2d.LinearShape2D)
     */
